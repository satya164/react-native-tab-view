...
A cross-platform Tab View component for React Native. Implemented using [`react-native-viewpager`](https://github.com/callstack/react-native-viewpager) on Android & iOS, and [PanResponder](https://reactnative.dev/docs/panresponder) on Web.
